      ...
      <div className="col s8 offset-s2 hide-on-small-only hide-on-med-and-down">
        <Slickder {...settings}>
          <div className="sliderick">
            <Image cloudName="wterrerocloud" publicId="myportfolio/Browser_ch7njb.png" />
          ...
          <div className="sliderick">
            <Image cloudName="wterrerocloud" publicId="myportfolio/mobile_acoap4.png" />
          ...
          <div className="sliderick">
            <Image cloudName="wterrerocloud" publicId="myportfolio/Code_ppxqr3.png" />
          ...
          <div className="sliderick">
            <Image cloudName="wterrerocloud" publicId="myportfolio/Delivery_gsnnhk.png" />
          ...
          <div className="sliderick">
            <Image cloudName="wterrerocloud" publicId="myportfolio/Custom_z4kf7e.png" />
